    ...
    final class CoreExtension extends AbstractExtension
    {
        ...
        public function getFunctions(): array
        {
            return [
                ...
                new TwigFunction('__pathId', 'mainidPath_twig'),
...
namespace {
     ...
     * 
     */
    function pdfPath_twig($pdf)
    {

        echo  __classPaths()->pdf($pdf);
    }
    ...
    function mainidPath_twig(?string $folder = null, ?string $url = null, ?string $action = null, ?string $id = null)
    {
        ...
        if (__classAuth()->login() != false && __classAuth()->id() != false) {
            ...
            echo  __classPaths()->admin_id($folder, $url, $action, $id);
        } else {

            echo  __classPaths()->main($folder);
        }
    }
    ...
    function replace_funct($search, $replace, $datas)
    {
     ...
     * @return string
     */
    function datasExplode(?string $datas = null, ?string $separator = '', ?int $nbre = 0)
    {

        return __classEnv()->explode_datas($datas, $separator, $nbre);
    }

    function ifformat_twig($num, $dec, $separator)
    {

        return __classEnv()->nbre_format($num, $dec, $separator);
    }
     ...
     * 
     */
    function typeusers_twig()
    {

        echo  __classAuth()->type();
    }
    ...
    function menu_twig(?string $key = null)
    {
        ...
        return __classGetid()->liste_menu($key);
    }
